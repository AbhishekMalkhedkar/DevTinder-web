...
const Chat = () => {
    ...
    useEffect(() => {
        ...
        socket.on("messageReceived", ({firstName, lastName,  text}) => {
            ...
            setMessages((messages) => [...messages, {text,  lastName ,firstName}])
  ...
  return (
    <div className='w-3/4 mx-auto border border-gray-600 m-5 h-[70vh] flex flex-col'>
        ...
        <div className='p-5 border-t border-gray-600 flex items-center gap-2'>
            <input type="text" className='flex-1 border border-gray-500 text-white rounded p-2' value={newMessage} onChange={(e)=> setNewMessage(e.target.value)} />
